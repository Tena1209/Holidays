...
public class MainActivity extends AppCompatActivity implements GetDataFromInternet.AsyncResponse, MyAdapter.ListItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            URL url = new URL("https://calendarific.com/api/v2/holidays?api_key=0210471b3084b69b1cacd9bb1a5c4da4b2ad3d09&country=RU&year=2023");
    ...
    public void proccessFinish(String output) {
        ...
        try {
            ...
            ArrayList<String> namesHoliay = new ArrayList<String>();
            ...
            //ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, namesHoliay);
